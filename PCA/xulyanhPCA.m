function varargout = xulyanhPCA(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @xulyanhPCA_OpeningFcn, ...
                   'gui_OutputFcn',  @xulyanhPCA_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before xulyanhPCA is made visible.
function xulyanhPCA_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = xulyanhPCA_OutputFcn(hObject, eventdata, handles) 
...
imshow(anhtim);
title('Photo found');
str=strcat('Photo name:', OutputName);
